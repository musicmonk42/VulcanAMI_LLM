...
class TestEmbeddingConfig:
    ...
    def test_custom_config(self):
        config = EmbeddingConfig(
            architecture=EmbeddingArchitecture.LSTM,
            embedding_dim=512,
            hidden_size=256
        )
...
class TestVulcanCandidateScorer:
    ...
    def test_diversity_penalty(self):
        ...
        # Similar candidate
        penalty_similar = scorer._apply_diversity_penalty("test candidate again", context)
        
        # Dissimilar candidate
        penalty_different = scorer._apply_diversity_penalty("completely different words", context)
    ...
    def test_repetition_penalty(self):
        ...
        # Non-repetitive
        penalty_norep = scorer._apply_repetition_penalty("different words each time", {})
