...
class IRFeedForward:
    def build_ir(
        self, hidden_size: int, intermediate_size: int, dropout_p: float = 0.1
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "nodes": [
                ...
                # This node takes the input and determines which FFN expert(s) (the SwiGLU path) to activate.
                {
                    "id": "ffn_dynamic_gate",
                    "type": "moe_gate",
                    "params": {"experts": 4, "mode": "top_k_select"},
                },
                {
                    "id": "ffn_gate",
                    "type": "transform",
                    "params": {"operation": "linear_gate", "to": intermediate_size},
                },
                {
                    "id": "ffn_expand",
                    "type": "transform",
                    "params": {"operation": "linear_expand", "to": intermediate_size},
                },
                {
                    "id": "ffn_swiglu",
                    "type": "filter",
                    "params": {"operation": "swiglu"},
                },
                {
                    "id": "ffn_project",
                    "type": "transform",
                    "params": {"operation": "linear_project", "to": hidden_size},
                },
                {"id": "ffn_dropout", "type": "dropout", "params": {"p": dropout_p}},
                {
                    "id": "ffn_residual",
                    "type": "combine",
                    "params": {"mode": "add_scale", "scale": 0.5},
                },
            ],
            "edges": [
