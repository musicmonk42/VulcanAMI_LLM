...
class TestGradientSurgeryUnlearner:
    ...
    def test_unlearn_batch_empty_sets(self):
        ...
        result = unlearner.unlearn_batch(forget_set=[], retain_set=[], iterations=5)
    ...
    def test_gradient_surgery(self):
        ...
        surgical_grads = unlearner._gradient_surgery(
            forget_grads, retain_grads, regularization=0.001
        )
...
class TestUnlearningEngine:
    ...
    def test_initialization(self):
        ...
        merkle_graph = Mock()
        engine = UnlearningEngine(merkle_graph=merkle_graph, method="gradient_surgery")
    ...
    def test_unlearn_gradient_surgery(self):
        ...
        result = engine.unlearn(
            data_to_data_to_forget=forget, data_to_data_to_retain=retain
        )
    ...
    def test_unlearn_sisa(self):
        ...
        engine = UnlearningEngine(
            merkle_graph=merkle_graph, method="sisa", shard_count=5
        )
    ...
    def test_unlearn_influence(self):
        ...
        merkle_graph = Mock()
        engine = UnlearningEngine(merkle_graph=merkle_graph, method="influence")
    ...
    def test_unlearn_amnesiac(self):
        ...
        merkle_graph = Mock()
        engine = UnlearningEngine(merkle_graph=merkle_graph, method="amnesiac")
    ...
    def test_unlearn_certified(self):
        ...
        merkle_graph = Mock()
        engine = UnlearningEngine(merkle_graph=merkle_graph, method="certified")
    ...
    def test_verification(self):
        ...
        merkle_graph = Mock()
        engine = UnlearningEngine(merkle_graph=merkle_graph, enable_verification=True)
    ...
    def test_get_affected_shards(self):
        ...
        merkle_graph = Mock()
        engine = UnlearningEngine(merkle_graph=merkle_graph, shard_count=10)
    ...
    async def test_unlearn_async(self):
        ...
        result = await engine.unlearn_async(
            data_to_forget=forget, data_to_retain=retain
        )
...
class TestUnlearningIntegration:
    ...
    def test_full_unlearning_workflow(self):
        ...
        # Perform unlearning
        result = engine.unlearn(data_to_forget=forget_data, data_to_retain=retain_data)
    ...
    def test_multiple_methods_comparison(self):
        ...
        for method in methods:
            engine = UnlearningEngine(merkle_graph=merkle_graph, method=method)

            result = engine.unlearn(
                data_to_forget=[b"item1"], data_to_retain=[b"item2", b"item3"]
            )
