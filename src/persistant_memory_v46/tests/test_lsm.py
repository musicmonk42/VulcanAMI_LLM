...
from lsm import BloomFilter, Packfile, MerkleNode, MerkleLSMDAG, MerkleLSM
...
class TestPackfile:
    ...
    def test_initialization(self):
        ...
        data = b"test data"
        pack = Packfile(pack_id="pack-123", level=0, data=data)
...
class TestMerkleLSMDAG:
    ...
    def test_add_node(self):
        ...
        node_hash = dag.add_node(pack_ids=["pack1", "pack2"], metadata={"level": 0})
    ...
    def test_add_node_with_parents(self):
        ...
        # Add child node
        child_hash = dag.add_node(pack_ids=["pack2"], parent_hashes=[parent_hash])
...
class TestMerkleLSM:
    ...
    def test_initialization(self):
        ...
        lsm = MerkleLSM(packfile_size_mb=32, compaction_strategy="adaptive")
    ...
    def test_memtable_flush(self):
        ...
        lsm = MerkleLSM(packfile_size_mb=1, background_compaction=False)
    ...
    def test_compaction_leveled(self):
        ...
        lsm = MerkleLSM(compaction_strategy="leveled", background_compaction=False)
    ...
    def test_compaction_adaptive(self):
        ...
        lsm = MerkleLSM(compaction_strategy="adaptive", background_compaction=False)
    ...
    def test_bloom_filter_optimization(self):
        ...
        lsm = MerkleLSM(bloom_filter=True, background_compaction=False)
