...
def compute_adaptive_range(
    ...
    if artifact_class in [ArtifactClass.CONFLICT, ArtifactClass.CITATION]:
        if chunk_type == ChunkType.CHILD:
            ...
            end = min(meta.parent_size, meta.child_offset + meta.child_length + context_size)
    ...
    if artifact_class == ArtifactClass.MEDIA:
        ...
        end = ((meta.child_offset + meta.child_length + block_size - 1) // block_size) * block_size
    ...
    if artifact_class == ArtifactClass.CODE and chunk_type == ChunkType.CHILD:
        ...
        end = min(meta.parent_size, meta.child_offset + meta.child_length + line_context)
    ...
    if meta.access_frequency > 10 and strategy == ReadStrategy.PREFETCH:
        ...
        end = min(meta.parent_size, meta.child_offset + meta.child_length + prefetch_size)
