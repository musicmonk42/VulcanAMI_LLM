...
class PackHeaderV2:
    ...
    def get_info(self) -> dict:
        ...
        return {
            ...
            'merkle_root': self.pack_merkle_root.hex() if self.pack_merkle_root != bytes(32) else None,
            'packer_version': self.packer_semver.decode('ascii', errors='replace').rstrip('\x00'),
