"""Persistence-owned segmented canonical audit (vulcan-audit/2)."""
from __future__ import annotations
import copy, fcntl, hashlib, json, math, os, re, threading, unicodedata
from datetime import datetime, timezone
from pathlib import Path
from typing import Any
from .events import EVENT_FAMILY_BY_TYPE, TERMINAL_CASE_EVENTS, PREPARED_EVENTS, COMMIT_EVENTS, ABORT_EVENTS, validate_event_data
from .index import AuditPage, add_event as _index_add_event, empty_index as _empty_index, paginate_sequences as _paginate_sequences, read_index as _read_index, write_index as _write_index, FIELD_BY_INDEX
