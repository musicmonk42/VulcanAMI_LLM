...
class TestObjective:
    ...
    def test_is_satisfied_none_values(self):
        ...
        obj = Objective(
            name="test", description="Test", target_value=None, current_value=None
        )
    ...
    def test_distance_from_target(self):
        ...
        obj = Objective(
            name="test", description="Test", target_value=0.9, current_value=0.7
        )
    ...
    def test_distance_from_target_none(self):
        ...
        obj = Objective(
            name="test", description="Test", target_value=None, current_value=0.7
        )
    ...
    def test_to_dict(self):
        ...
        obj = Objective(
            name="test", description="Test objective", priority=1, weight=0.8
        )
...
class TestAddObjective:
    ...
    def test_add_objective(self, empty_hierarchy):
        ...
        obj = Objective(name="new_obj", description="New objective", priority=1)
    ...
    def test_add_objective_invalid_parent(self, hierarchy):
        ...
        obj = Objective(name="new_obj", description="New", priority=1)
...
class TestGetDependencies:
    ...
    def test_get_direct_dependencies(self, hierarchy):
        ...
        obj = Objective(
            name="test_obj", description="Test", dependencies=["prediction_accuracy"]
        )
        hierarchy.add_objective(obj)
...
class TestConsistencyChecking:
    ...
    def test_detect_circular_dependency(self, empty_hierarchy):
        ...
        circular = next(
            (i for i in result["issues"] if i["type"] == "circular_dependency"), None
        )
    ...
    def test_detect_invalid_dependency(self, hierarchy):
        ...
        invalid = next(
            (i for i in result["issues"] if i["type"] == "invalid_dependency"), None
        )
    ...
    def test_detect_priority_inconsistency(self, empty_hierarchy):
        ...
        priority_issues = next(
            (i for i in result["issues"] if i["type"] == "priority_inconsistency"), None
        )
...
class TestObjectiveQueries:
    ...
    def test_is_derived_objective(self, hierarchy):
        ...
        obj = Objective(
            name="derived", description="Derived", objective_type=ObjectiveType.DERIVED
        )
        hierarchy.add_objective(obj)
...
class TestThreadSafety:
    ...
    def test_concurrent_add_objectives(self, empty_hierarchy):
        ...
        threads = [threading.Thread(target=add_objective, args=(i,)) for i in range(10)]
        for t in threads:
            t.start()
        for t in threads:
            t.join()
...
class TestEdgeCases:
    ...
    def test_empty_constraints(self):
        ...
        obj = Objective(
            name="test", description="Test", constraints={}, current_value=0.5
        )
    ...
    def test_self_dependency(self, empty_hierarchy):
        ...
        obj = Objective(
            name="self_dep", description="Self-dependent", dependencies=["self_dep"]
        )
    ...
    def test_very_long_dependency_chain(self, empty_hierarchy):
        ...
        for i in range(20):
            ...
            obj = Objective(
                name=f"obj_{i}", description=f"Objective {i}", dependencies=deps
            )
            empty_hierarchy.add_objective(obj)
...
class TestIntegration:
    ...
    def test_conflict_detection_workflow(self, pristine_hierarchy):
        ...
        obj_a = Objective(
            name="speed", description="Maximize speed", conflicts_with=["accuracy"]
        )
        obj_b = Objective(name="accuracy", description="Maximize accuracy")
