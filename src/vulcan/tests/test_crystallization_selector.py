...
class TestCrystallizationSelector:
    ...
    def test_apply_learning_adjustment(self, selector):
        ...
        base_score = 0.5
        adjusted = selector._apply_learning_adjustment(CrystallizationMethod.STANDARD, base_score)
    ...
    def test_identify_fallbacks(self, selector):
        ...
        fallbacks = selector._identify_fallbacks(scores, CrystallizationMethod.CASCADE_AWARE)
    ...
    def test_update_performance_success(self, selector):
        ...
        initial_successes = selector.performance_metrics[CrystallizationMethod.STANDARD]['successes']
        
        selector.update_performance(CrystallizationMethod.STANDARD, True)
        
        new_successes = selector.performance_metrics[CrystallizationMethod.STANDARD]['successes']
    ...
    def test_update_performance_failure(self, selector):
        ...
        initial_failures = selector.performance_metrics[CrystallizationMethod.STANDARD]['failures']
        
        selector.update_performance(CrystallizationMethod.STANDARD, False)
        
        new_failures = selector.performance_metrics[CrystallizationMethod.STANDARD]['failures']
...
class TestEdgeCases:
    ...
    def test_trace_without_attributes(self, selector):
        ...
        minimal_trace = Mock(spec=['trace_id', 'success', 'domain', 'confidence', 
                                     'actions', 'metadata', 'context', 'outcomes', 'dependencies'])
        minimal_trace.trace_id = "minimal_001"
        minimal_trace.success = True
        minimal_trace.domain = "general"
        minimal_trace.confidence = 0.5
    ...
    def test_very_high_complexity(self, selector):
        ...
        assert chars.complexity in [TraceComplexity.COMPLEX, TraceComplexity.HIGHLY_COMPLEX]
