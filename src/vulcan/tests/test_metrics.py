...
class TestInitialization(unittest.TestCase):
    ...
    def test_custom_initialization(self):
        ...
        collector = EnhancedMetricsCollector(
            max_histogram_size=5000,
            max_timeseries_size=500,
...
class TestTimeseries(unittest.TestCase):
    ...
    def test_get_timeseries_window(self):
        ...
        series = self.collector.get_timeseries_window('test_series', start_time=start_time)
...
class TestThreadSafety(unittest.TestCase):
    ...
    def test_concurrent_gauge_updates(self):
        ...
        threads = [threading.Thread(target=update_gauge, args=(i,)) for i in range(num_threads)]
        for t in threads:
            t.start()
