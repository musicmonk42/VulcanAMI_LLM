...
class TestRollbackManager:
    ...
    @pytest.mark.timeout(10)
    def test_create_multiple_snapshots(self, rollback_manager, sample_state, sample_action_log):
    ...
    @pytest.mark.timeout(10)
    def test_snapshot_persistence(self, temp_storage_dir, sample_state, sample_action_log):
    ...
    @pytest.mark.timeout(10)
    def test_snapshot_compression(self, temp_storage_dir, sample_state, sample_action_log):
    ...
    @pytest.mark.timeout(10)
    def test_rollback_to_latest(self, rollback_manager, sample_state, sample_action_log):
    ...
    @pytest.mark.timeout(10)
    def test_rollback_to_specific_snapshot(self, rollback_manager, sample_state, sample_action_log):
        """Test rolling back to a specific snapshot."""
        # Create multiple snapshots
        snapshot_ids = []
        for i in range(3):
            state = {**sample_state, 'version': i}
            sid = rollback_manager.create_snapshot(state=state, action_log=sample_action_log)
            snapshot_ids.append(sid)
        
        # Rollback to first snapshot
        result = rollback_manager.rollback(
            snapshot_id=snapshot_ids[0],
            reason="specific_rollback"
        )
    ...
    @pytest.mark.timeout(10)
    def test_get_snapshot_history(self, rollback_manager, sample_state, sample_action_log):
        """Test retrieving snapshot history."""
        # Create snapshots
        for i in range(5):
            rollback_manager.create_snapshot(
                state={**sample_state, 'i': i},
                action_log=sample_action_log
            )
    ...
    @pytest.mark.timeout(10)
    def test_get_rollback_history(self, rollback_manager, sample_state, sample_action_log):
    ...
    @pytest.mark.timeout(10)
    def test_export_snapshot(self, rollback_manager, sample_state, sample_action_log, temp_storage_dir):
    ...
    @pytest.mark.timeout(10)
    def test_import_snapshot(self, rollback_manager, sample_state, sample_action_log, temp_storage_dir):
    ...
    @pytest.mark.timeout(10)
    def test_max_snapshots_limit(self, temp_storage_dir, sample_state, sample_action_log):
    ...
    @pytest.mark.timeout(10)
    def test_snapshot_integrity_verification(self, rollback_manager, sample_state, sample_action_log):
    ...
    @pytest.mark.timeout(10)
    def test_persistence_across_restarts(self, temp_storage_dir, sample_state, sample_action_log):
...
class TestAuditLogger:
    ...
    def test_query_filters_whitelist(self, audit_logger):
        ...
        results = audit_logger.query_logs(
            filters={'entry_type': 'test'}
        )
        
        # Invalid filter field - should be ignored
        results = audit_logger.query_logs(
            filters={'malicious_field': 'value'}
        )
    ...
    def test_get_summary(self, audit_logger, sample_safety_report):
        ...
        audit_logger.log_safety_decision(
            {'type': 'test'},
    ...
    def test_concurrent_logging(self, audit_logger):
        ...
        def log_entries():
            for i in range(10):
                audit_logger.log_event('thread_test', {'thread': threading.current_thread().name})
...
class TestIntegration:
    ...
    @pytest.mark.timeout(15)
    def test_rollback_with_audit(self, temp_storage_dir, sample_state, sample_action_log):
