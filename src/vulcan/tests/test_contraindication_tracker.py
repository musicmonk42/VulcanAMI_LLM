...
class TestContraindicationDatabase:
    ...
    def test_register_contraindication(self, contraindication_db, sample_contraindication):
    ...
    def test_register_duplicate_updates_frequency(self, contraindication_db):
        ...
        initial_freq = contraindication_db.get_contraindications("principle_001")[0].frequency
    ...
    def test_batch_register(self, contraindication_db):
        ...
        contras = [
            ("principle_001", Contraindication(condition="c1", failure_mode="performance")),
            ("principle_002", Contraindication(condition="c2", failure_mode="correctness")),
            ("principle_003", Contraindication(condition="c3", failure_mode="stability"))
        ]
    ...
    def test_check_domain_compatibility_compatible(self, contraindication_db):
        ...
        is_compatible, blocking = contraindication_db.check_domain_compatibility("p1", "control")
    ...
    def test_check_domain_compatibility_incompatible(self, contraindication_db):
        ...
        is_compatible, blocking = contraindication_db.check_domain_compatibility("p1", "optimization")
    ...
    def test_get_domain_contraindicated_principles(self, contraindication_db):
        ...
        principles = contraindication_db.get_domain_contraindicated_principles("optimization")
    ...
    def test_get_failure_pattern_principles(self, contraindication_db):
        ...
        timeout_principles = contraindication_db.get_failure_pattern_principles("timeout")
...
class TestContraindicationGraph:
    ...
    def test_add_edge(self, contraindication_graph, mock_principle):
        ...
        assert (mock_principle.id, principle2.id) in contraindication_graph.impact_weights
        assert contraindication_graph.impact_weights[(mock_principle.id, principle2.id)] == 0.8
...
class TestCascadeAnalyzer:
    ...
    def test_simulate_failure_with_contraindications(self, cascade_analyzer, mock_principle):
...
class TestIntegration:
    ...
    def test_performance_with_large_graph(self):
        ...
        # Calculate risks
        risk = graph.calculate_cascade_risk(principles[0].id)
