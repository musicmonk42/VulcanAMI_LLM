...
class TestToolSafetyManager:
    ...
    def test_check_tool_safety_pass(self, tool_safety_manager, basic_contract, basic_context):
    ...
    def test_check_tool_safety_precondition_fail(self, tool_safety_manager, basic_contract):
    ...
    def test_check_tool_safety_veto(self, tool_safety_manager):
        ...
        contract = ToolSafetyContract(
            ...
            veto_conditions=[
                Condition("emergency", "==", True, "No emergency mode")
            ],
            risk_score=0.3
        )
    ...
    def test_check_tool_safety_rate_limit(self, tool_safety_manager, basic_contract):
        ...
        safe_after_many, report_after_many = tool_safety_manager.check_tool_safety("rate_limited", context)
        
        assert safe1 is True
        # After many rapid calls, should hit rate limit
        if not safe_after_many:
            assert any("rate limit" in reason.lower() for reason in report_after_many.reasons)
    
    def test_check_tool_safety_resource_limit(self, tool_safety_manager, basic_contract):
    ...
    def test_get_tool_safety_report(self, tool_safety_manager, basic_contract, basic_context):
    ...
    def test_update_contract_risk_auto(self, tool_safety_manager, basic_contract, basic_context):
...
class TestToolSafetyGovernor:
    ...
    def test_validate_execution_result_pass(self, tool_safety_governor):
        ...
        result = {"success": True}
        valid, failures = tool_safety_governor.validate_execution_result("test_exec", result)
    ...
    def test_validate_execution_result_fail(self, tool_safety_governor):
        ...
        result = {"success": False}
        valid, failures = tool_safety_governor.validate_execution_result("test_exec_fail", result)
    ...
    def test_update_governance_policy(self, tool_safety_governor):
        ...
        assert tool_safety_governor.governance_policies['max_parallel_tools'] != original
