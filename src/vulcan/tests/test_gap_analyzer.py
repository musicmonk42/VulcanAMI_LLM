...
class TestDecompositionAnalyzer:
    ...
    def test_analyze_structural_failures(self):
        ...
        failures = [
            {'structure': 'tree', 'domain': 'test'} for _ in range(6)
        ]
...
class TestAnomalyAnalyzer:
    ...
    def test_detect_anomalies_insufficient_data(self):
        ...
        predictions = [
            {'value': 1.0, 'confidence': 0.8, 'variance': 0.1, 'error': 0.1}
        ]
...
class TestLatentGapDetector:
    ...
    def test_detect_from_patterns(self):
        ...
        patterns = {
            'test_pattern': [
                {'value': np.random.randn()} for _ in range(50)
...
class TestGapAnalyzer:
    ...
    def test_analyze_prediction_errors(self):
        ...
        for i in range(5):
            analyzer.record_failure('prediction', {
                'cause': 'x',
                'effect': 'y',
                'magnitude': 0.5,
                'domain': 'physics',
    ...
    def test_analyze_transfer_failures(self):
        ...
        for i in range(5):
            analyzer.record_failure('transfer', {
                'source_domain': 'A',
                'target_domain': 'B',
                'success_rate': 0.3
            })
