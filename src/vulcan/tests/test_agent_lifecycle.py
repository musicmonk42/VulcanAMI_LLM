...
class TestAgentCapability(unittest.TestCase):
    ...
    def test_can_handle_capability(self):
        ...
        self.assertTrue(AgentCapability.GENERAL.can_handle_capability(
        ...
        self.assertTrue(AgentCapability.PERCEPTION.can_handle_capability(
            AgentCapability.PERCEPTION
        ))
        self.assertFalse(AgentCapability.PERCEPTION.can_handle_capability(
            AgentCapability.REASONING
        ))
...
class TestStateTransitionRules(unittest.TestCase):
    ...
    def test_valid_transitions_from_uninitialized(self):
        ...
        self.assertTrue(StateTransitionRules.is_valid_transition(
        ...
        # Invalid transitions
        self.assertFalse(StateTransitionRules.is_valid_transition(
    ...
    def test_validate_transition_logging(self):
        ...
        self.assertTrue(StateTransitionRules.validate_transition(
            AgentState.IDLE, AgentState.WORKING, "test_agent"
        ))
        
        # Invalid transition should return False
        self.assertFalse(StateTransitionRules.validate_transition(
...
class TestIntegrationScenarios(unittest.TestCase):
    ...
    def test_agent_lifecycle_happy_path(self):
        ...
        for i in range(5):
            ...
            self.assertTrue(agent.transition_state(AgentState.IDLE, f"Task {i} complete"))
    ...
    def test_parent_child_job_relationship(self):
        ...
        child1 = create_job_provenance(
            job_id="child_job_1",
            graph_id="child_graph_1",
            parent_job_id=parent.job_id
        )
        
        child2 = create_job_provenance(
            job_id="child_job_2",
            graph_id="child_graph_2",
            parent_job_id=parent.job_id
        )
