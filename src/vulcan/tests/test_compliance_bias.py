...
from vulcan.safety.compliance_bias import (
    ComplianceMapper,
    BiasDetector,
    LRUCache
)
...
class TestComplianceMapper:
    ...
    def test_check_compliance_single_standard(self, compliance_mapper, sample_action, sample_context):
    ...
    def test_check_compliance_all_standards(self, compliance_mapper, sample_action, sample_context):
    ...
    def test_check_compliance_caching(self, compliance_mapper, sample_action, sample_context):
    ...
    def test_cache_size_limit(self, compliance_mapper, sample_context):
        ...
        assert len(compliance_mapper.compliance_cache) <= compliance_mapper.cache_max_size
    ...
    def test_gdpr_data_minimization_pass(self, compliance_mapper):
        ...
        passed, details = compliance_mapper._check_gdpr_data_minimization(action, context)
    ...
    def test_gdpr_purpose_limitation_pass(self, compliance_mapper):
        ...
        passed, details = compliance_mapper._check_gdpr_purpose_limitation(action, context)
        assert passed is True
    ...
    def test_get_compliance_stats(self, compliance_mapper, sample_action, sample_context):
...
class TestBiasDetector:
    ...
    def test_detect_bias_basic(self, bias_detector):
        ...
        context = {
            'user_diversity_score': 0.7,
            'historical_bias_score': 0.1
        }
    ...
    def test_bias_mitigation_recommendations(self, bias_detector):
        ...
        recommendations = bias_detector._generate_bias_mitigations(bias_scores, detailed_analysis)
    ...
    def test_high_bias_detection(self, bias_detector):
        ...
        context = {
            ...
            'sensitive_attributes_present': True
        }
    ...
    def test_outcome_distribution_encoding(self, bias_detector):
        ...
        outcomes = {
            'group_a': {'probability': 0.8},
            'group_b': {'probability': 0.6}
        }
    ...
    def test_model_forward_pass(self, bias_detector):
        ...
        with torch.no_grad():
            for model_name, model in bias_detector.bias_models.items():
                if model_name in ['demographic', 'representation', 'outcome', 'allocation']:
...
class TestIntegration:
    ...
    def test_compliance_and_bias_together(self, compliance_mapper, bias_detector):
        ...
        compliance_result = compliance_mapper.check_compliance(
            action,
            context,
            standards=[ComplianceStandard.AI_ACT]
        )
