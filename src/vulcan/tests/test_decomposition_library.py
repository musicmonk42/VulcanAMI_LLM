...
class TestPattern:
    ...
    def test_pattern_signature_consistency(self):
        ...
        pattern1 = Pattern(
            pattern_id="p1",
            structure=None,
            features={'node_count': 3, 'edge_count': 2}
        )
...
class TestDecompositionPrinciple:
    ...
    def test_principle_update_success_rate(self, sample_principle):
        ...
        logger.info(f"✓ Success rate update test passed: {sample_principle.success_rate:.2f}")
...
class TestSimilaritySearch:
    ...
    def test_find_similar_basic(self, library):
        ...
        logger.info(f"✓ Basic similarity search test passed: found {len(similar)} similar patterns")
...
class TestStratifiedLibrary:
    ...
    def test_update_usage_statistics(self, stratified_library, sample_pattern):
        ...
        stratified_library.update_usage_statistics(
            sample_pattern.pattern_id,
            domain='optimization'
        )
        
        assert stratified_library.pattern_frequency[sample_pattern.pattern_id] == 1
        assert 'optimization' in stratified_library.pattern_domains[sample_pattern.pattern_id]
    ...
    def test_get_patterns_by_frequency(self, stratified_library):
        ...
        logger.info(f"✓ Get patterns by frequency test passed: {len(frequent)} frequent patterns")
    ...
    def test_get_cross_domain_patterns(self, stratified_library):
        ...
        logger.info(f"✓ Get cross-domain patterns test passed: {len(cross_domain)} patterns")
    ...
    def test_get_domain_statistics(self, stratified_library, sample_principle):
        ...
        if sample_principle.pattern:
            stratified_library.update_usage_statistics(
                sample_principle.pattern.pattern_id,
                domain='optimization'
            )
    ...
    def test_domain_categorization(self, stratified_library):
        ...
        logger.info(f"✓ Domain categorization test passed: {len(categories)} categories")
