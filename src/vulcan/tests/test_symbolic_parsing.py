...
from vulcan.reasoning.symbolic.parsing import (
    Lexer, Parser, TokenType, Token,
    ASTNode, NodeType,
    FormulaParser, FormulaUtils, FormulaBuilder,
    CNFConverter, PrenexConverter, Skolemizer,
    VariableRenamer, ClauseExtractor, ASTConverter
)
from vulcan.reasoning.symbolic.core import Variable, Constant, Function, Literal, Clause
...
class TestFormulaUtils:
    ...
    def test_get_free_variables_simple(self):
        ...
        pred = ASTNode(NodeType.PREDICATE, value="P", children=[
    ...
    def test_get_free_variables_quantified(self):
        ...
        body = ASTNode(NodeType.PREDICATE, value="P", children=[
            ASTNode(NodeType.VARIABLE, value="X"),
            ASTNode(NodeType.VARIABLE, value="Y")
        ])
        formula = ASTNode(NodeType.FORALL, children=[body], 
    ...
    def test_substitute_variable(self):
        ...
        original = ASTNode(NodeType.PREDICATE, value="P", children=[
            ASTNode(NodeType.VARIABLE, value="X")
        ])
...
class TestCNFConverter:
    ...
    def test_move_negations_inward_double_neg(self):
        ...
        # ~~P becomes P
        p = ASTNode(NodeType.PREDICATE, value="P", children=[])
        double_neg = ASTNode(NodeType.NOT, children=[
            ASTNode(NodeType.NOT, children=[p])
        ])
