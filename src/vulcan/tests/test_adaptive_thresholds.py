...
class TestRecordingAttempts:
    ...
    def test_record_failure(self, performance_tracker):
        ...
        performance_tracker.record_failure(
            "problem_123",
            "timeout",
            strategy_used="brute_force_search"
        )
...
class TestCostEstimation:
    ...
    def test_get_cost_with_class(self, strategy_profiler):
        ...
        strategy_profiler.update("strategy_A", latency=1.0, success=True,
                                problem_class="class1")
        strategy_profiler.update("strategy_A", latency=3.0, success=True,
                                problem_class="class1")
...
class TestThreadSafety:
    ...
    def test_strategy_profiler_concurrent_updates(self, strategy_profiler):
        ...
        def update_strategies():
            for i in range(50):
                strategy_profiler.update(f"strategy_{i%5}", 
                                       latency=float(i%10), 
                                       success=i%2==0)
...
class TestIntegration:
    ...
    def test_thresholds_with_performance_tracker(self, adaptive_thresholds, 
                                                 performance_tracker):
    ...
    def test_profiler_with_performance_tracker(self, strategy_profiler,
                                               performance_tracker):
...
class TestEdgeCases:
    ...
    def test_performance_record_with_none_values(self, performance_tracker):
        ...
        performance_tracker.record_success("prob", "strategy", execution_time=0.0,
                                         metadata=None)
