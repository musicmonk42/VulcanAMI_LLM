...
class TestVersionedKnowledgeBase:
    ...
    def test_batch_store(self, kb):
        ...
        principles = [
            MockPrinciple(id=f"test_{i}", domain="math")
            for i in range(5)
        ]
...
class TestKnowledgeIndex:
    ...
    def test_find_relevant_by_patterns(self, index):
        ...
        index.index_principle(MockPrinciple(
            id="p1",
            patterns=["addition", "subtraction"]
        ))
        index.index_principle(MockPrinciple(
