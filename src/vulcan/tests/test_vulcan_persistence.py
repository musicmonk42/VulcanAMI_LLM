...
class TestMemoryCompression:
    ...
    def test_compression_ratio(self, sample_memory):
        ...
        ratio = MemoryCompressor.estimate_compression_ratio(
            sample_memory, CompressionType.LZ4
        )
...
class TestMemoryPersistence:
    ...
    def test_save_batch(self, persistence, sample_memories):
        ...
        saved_count = persistence.save_batch(
            sample_memories, compress=True, compression_type=CompressionType.LZ4
        )
...
class TestVersionControl:
    ...
    def test_create_version(self, version_control, sample_memory):
        ...
        version_id = version_control.create_version(
            sample_memory, message="Initial version", author="test_user"
        )
    ...
    def test_version_history(self, version_control, sample_memory):
        ...
        for i in range(5):
            ...
            version_control.create_version(sample_memory, message=f"Update {i}")
...
class TestEncryption:
    ...
    def test_save_with_encryption(self, persistence_with_encryption, sample_memory):
        ...
        success = persistence_with_encryption.save_memory(sample_memory, immediate=True)
...
class TestEdgeCases:
    ...
    def test_save_empty_content(self, persistence):
        ...
        memory = Memory(
            id="empty_test", type=MemoryType.WORKING, content="", timestamp=time.time()
        )
    ...
    def test_save_none_content(self, persistence):
        ...
        memory = Memory(
            id="none_test", type=MemoryType.WORKING, content=None, timestamp=time.time()
        )
    ...
    def test_save_large_content(self, persistence):
        ...
        success = persistence.save_memory(
            memory, compress=True, compression_type=CompressionType.LZ4, immediate=True
        )
    ...
    def test_version_control_with_missing_database(self, temp_dir):
        ...
        # Should work
        memory = Memory(
            id="test", type=MemoryType.WORKING, content="test", timestamp=time.time()
        )
