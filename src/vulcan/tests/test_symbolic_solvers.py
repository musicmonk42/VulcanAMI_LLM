...
class TestFactor:
    ...
    def test_factor_multiply_simple(self):
        ...
        factor1 = Factor(
            variables=["X"],
            values={(True,): 0.3, (False,): 0.7}
        )
        
        factor2 = Factor(
            variables=["Y"],
            values={(True,): 0.6, (False,): 0.4}
        )
...
class TestBayesianNetworkReasoner:
    ...
    def test_add_variable_with_parents(self):
        ...
        bn.add_variable("Sprinkler", VariableType.DISCRETE, 
                       domain=[True, False], parents=["Rain"])
    ...
    def test_set_cpt_with_parents(self):
        ...
        bn = BayesianNetworkReasoner()
        bn.add_variable("Rain", VariableType.DISCRETE, domain=[True, False])
        bn.add_variable("WetGrass", VariableType.DISCRETE, 
                       domain=[True, False], parents=["Rain"])
    ...
    def test_eliminate_variable(self):
        ...
        factor1 = Factor(variables=["X", "Y"], values={
            (True, True): 0.3,
            (True, False): 0.7,
            (False, True): 0.2,
            (False, False): 0.8
        ...
        factor2 = Factor(variables=["Y", "Z"], values={
            (True, True): 0.6,
            (True, False): 0.4,
            (False, True): 0.5,
            (False, False): 0.5
...
class TestIntegration:
    ...
    def test_bayesian_network_inference_chain(self):
        ...
        bn.add_variable("Rain", VariableType.DISCRETE, domain=[True, False], parents=["Cloudy"])
        bn.add_variable("WetGrass", VariableType.DISCRETE, domain=[True, False], parents=["Rain"])
    ...
    def test_bayesian_network_v_structure(self):
        ...
        bn.add_variable("WetGrass", VariableType.DISCRETE, 
                       domain=[True, False], parents=["Rain", "Sprinkler"])
        ...
        for row in range(n):
            for col1 in range(n):
                for col2 in range(col1 + 1, n):
                    ...
                    solver.add_constraint([c1, c2], lambda a, c1=c1, c2=c2: a[c1] != a[c2])
