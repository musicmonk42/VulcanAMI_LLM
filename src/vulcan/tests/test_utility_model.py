...
from vulcan.reasoning.selection.utility_model import (
    UtilityModel, UtilityWeights, UtilityContext, UtilityComponents,
    ContextMode, LinearUtility, ExponentialUtility, LogarithmicUtility,
    ThresholdUtility, SigmoidUtility, UtilityFunction
)
...
class TestUtilityWeights:
    ...
    def test_weights_normalize(self):
        ...
        # Should sum to 1.0
        total = weights.quality + weights.time_penalty + weights.energy_penalty + weights.risk_penalty
...
class TestUtilityComponents:
    ...
    def test_components_to_dict(self):
        ...
        components = UtilityComponents(
            quality_score=0.9, time_score=0.7, energy_score=0.8, risk_score=0.6,
            raw_quality=0.85, raw_time=1500, raw_energy=150, raw_risk=0.2
        )
...
class TestUtilityModel:
    ...
    def test_save_and_load_config(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert abs(new_model.mode_weights[ContextMode.BALANCED].quality - 1.5) < 1e-6
