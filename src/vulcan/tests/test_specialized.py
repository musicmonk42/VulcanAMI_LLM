...
def sample_episode():
    ...
    return Episode(
        ...
        end_time=time.time(),
        events=[
            {'type': 'action', 'content': 'started task', 'timestamp': time.time() - 3600},
            {'type': 'observation', 'content': 'observed result', 'timestamp': time.time() - 1800}
        ],
...
def sample_tool_concept():
    ...
    return ToolPerformanceConcept(
        ...
        attributes={'strengths': ['uncertainty handling'], 'weaknesses': ['computational cost']},
        relationships={},
...
class TestEpisode:
    ...
    def test_compute_duration(self, sample_episode):
        ...
        assert duration <= 3600.001  # Should be at most 1 hour (with floating-point tolerance)
...
class TestIntegration:
    ...
    def test_episodic_to_semantic(self, memory_config):
        ...
        sm.add_concept(
            name="neural_network",
            definition="Learned from episode",
            confidence=0.6
        )
    ...
    def test_all_memory_types_store_retrieve(self, memory_config):
        ...
        em_result = em.retrieve(MemoryQuery(
            query_type='episodic',
            content=None,
            embedding=None,
            time_range=None,
        ...
        sm_result = sm.retrieve(MemoryQuery(
            query_type='semantic',
            content=None,
            embedding=None,
            time_range=None,
        ...
        pm_result = pm.retrieve(MemoryQuery(
            query_type='procedural',
            content=None,
            embedding=None,
            time_range=None,
        ...
        wm_result = wm.retrieve(MemoryQuery(
            query_type='working',
            content=None,
            embedding=None,
            time_range=None,
