...
from vulcan.reasoning.selection.warm_pool import (
    WarmStartPool, ToolPool, PoolInstance, PoolStatistics, PoolState,
    ScalingPolicy, ResourceMonitor, DemandPredictor
)
...
class TestScalingPolicies:
    ...
    def create_warm_pool(self, scaling_policy='dynamic'):
        ...
        tools = {'tool1': MockTool("tool1")}
        config = {'scaling_policy': scaling_policy, 'min_pool_size': 1, 'max_pool_size': 3}
