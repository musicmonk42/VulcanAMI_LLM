...
class TestGovernanceManager:
    ...
    def test_register_stakeholder(self, governance_manager):
        ...
        assert governance_manager.stakeholder_registry['user_123']['type'] == StakeholderType.USER
    ...
    def test_request_approval_autonomous(self, governance_manager, sample_action, sample_context):
    ...
    def test_request_approval_auto_select_policy(self, governance_manager, sample_action, sample_context):
        """Test automatic policy selection based on risk."""
        # Low risk - should use autonomous
        low_risk_action = {**sample_action, 'risk_score': 0.2}
        result = governance_manager.request_approval(low_risk_action, context=sample_context)
        ...
        result = governance_manager.request_approval(high_risk_action, context=sample_context)
        assert 'safety' in result['policy_applied'].lower() or 'critical' in result['policy_applied'].lower()
    ...
    def test_process_autonomous(self, governance_manager, sample_action):
        ...
        result = governance_manager._process_autonomous('decision_1', sample_action, policy)
    ...
    def test_process_supervised(self, governance_manager, sample_action):
        ...
        result = governance_manager._process_supervised('decision_2', sample_action, policy)
    ...
    def test_get_governance_stats(self, governance_manager, sample_action, sample_context):
    ...
    def test_thread_safety(self, governance_manager, sample_action, sample_context):
        ...
        def make_request():
            result = governance_manager.request_approval(sample_action, context=sample_context)
...
class TestValueAlignmentSystem:
    ...
    def test_calculate_value_alignment_transparency(self, alignment_system):
        ...
        score = alignment_system._calculate_value_alignment(action, 'transparency', None)
    ...
    def test_modify_goal_allowed(self, alignment_system):
        ...
        result = alignment_system.modify_goal(
            'secondary',
            'add',
            'new_secondary_goal'
        )
...
class TestHumanOversightInterface:
    ...
    def test_request_human_approval_normal(self, oversight_interface, sample_action, sample_context):
    ...
    def test_request_human_approval_critical(self, oversight_interface, sample_action, sample_context):
    ...
    def test_get_monitoring_dashboard(self, oversight_interface, sample_action, sample_context):
        """Test getting monitoring dashboard."""
        # Generate some activity
        oversight_interface.request_human_approval(sample_action, context=sample_context)
...
class TestIntegration:
    ...
    def test_full_governance_flow(self, governance_manager, sample_action, sample_context):
        """Test complete governance flow."""
        # Register stakeholder
        governance_manager.register_stakeholder(
            'operator_1',
    ...
    def test_alignment_with_governance(self, governance_manager, alignment_system, sample_action):
...
class TestPerformance:
    ...
    def test_governance_many_decisions(self, governance_manager, sample_action, sample_context):
