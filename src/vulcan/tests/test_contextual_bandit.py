...
def simple_context():
    ...
    return BanditContext(
        ...
        problem_type="test",
        constraints={'time_budget': 1000.0, 'energy_budget': 1000.0, 'min_quality': 0.7}
    )
...
class TestContextualBandit:
    ...
    def test_epsilon_greedy_selection(self, bandit_5_actions, simple_context):
        ...
        assert action.tool_name in ['symbolic', 'probabilistic', 'causal', 'analogical', 'multimodal']
...
class TestAdaptiveBanditOrchestrator:
    ...
    def test_meta_learning(self, orchestrator, simple_context):
        ...
        for i in range(20):
            ...
            reward = 0.9 if action.metadata.get('bandit_algorithm') == 'epsilon_greedy' else 0.3
...
class TestToolSelectionBandit:
    ...
    def test_reward_computation(self, tool_selection_bandit):
        ...
        # Poor performance
        reward2 = tool_selection_bandit._compute_reward(0.0, 2000.0, 2000.0, constraints)
        assert reward2 < 0.5
