...
class TestActiveLearning:
    ...
    def test_expected_improvement_zero_std(self, basic_reasoner):
        ...
        with patch.object(basic_reasoner, 'predict_with_uncertainty_ensemble') as mock_predict:
...
class TestConstrainedOptimization:
    ...
    def test_add_constraint(self, basic_reasoner):
        ...
        basic_reasoner.add_constraint(constraint_fn, threshold=0.0, constraint_type='lt')
    ...
    def test_add_constraint_with_type(self, basic_reasoner):
        ...
        basic_reasoner.add_constraint(constraint_fn_lt, threshold=10.0, constraint_type='lt')
        
        # Greater than constraint  
        basic_reasoner.add_constraint(constraint_fn_gt, threshold=5.0, constraint_type='gt')
    ...
    def test_suggest_next_observation_constrained(self, basic_reasoner, sample_data):
        ...
        basic_reasoner.add_constraint(constraint_fn, threshold=0.0, constraint_type='gt')
        
        candidates = [np.array([[i]]) for i in range(1, 10)]
        next_obs = basic_reasoner.suggest_next_observation_constrained(candidates, method='ei')
