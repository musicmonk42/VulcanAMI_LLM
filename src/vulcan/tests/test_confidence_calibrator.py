...
class TestConfidenceCalibrator:
    ...
    def test_initialization_with_params(self):
        ...
        calibrator = ConfidenceCalibrator(method="platt", n_bins=20, window_size=500)
...
class TestModelConfidenceTracker:
    ...
    def test_initialization_with_params(self):
        """Test initialization with parameters"""
        tracker = ModelConfidenceTracker(
            decay_rate=0.9, min_confidence=0.2, max_confidence=0.8
        )
    ...
    def test_save_and_load_state(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert new_tracker.model_confidence == pytest.approx(
                tracker.model_confidence
            )
