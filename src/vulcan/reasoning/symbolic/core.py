...
class Unifier:
    ...
    def occurs_check(self, var: Variable, term: Term, 
                    subst: Dict[str, Term]) -> bool:
        """
    ...
    def apply_to_literal(self, literal: Literal, 
                        subst: Dict[str, Term]) -> Literal:
        """
    ...
    def apply_to_clause(self, clause: Clause, 
                       subst: Dict[str, Term]) -> Clause:
        """
