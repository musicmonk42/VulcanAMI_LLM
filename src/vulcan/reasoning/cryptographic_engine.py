...
class CryptoOperation(Enum):
    ...
    Attributes:
        SHA256: SHA-256 hash (256-bit, FIPS 180-4)
        SHA1: SHA-1 hash (160-bit, deprecated for security)
        SHA512: SHA-512 hash (512-bit, FIPS 180-4)
        SHA384: SHA-384 hash (384-bit, FIPS 180-4)
        SHA224: SHA-224 hash (224-bit, FIPS 180-4)
