...
def detect_mathematical_problem(
    ...
    ENHANCED: Lowered thresholds and expanded keyword detection to ensure
    mathematical modules are activated more aggressively. Previously,
    many valid math problems were not triggering full mathematical capabilities.
    ...
    # ENHANCED: Expanded mathematical domain keywords
    math_domains = [
        "math",
        "mathematics",
        "statistical",
        ...
        "numeric",
        "quantitative",
        # ENHANCED: Physics and theoretical domains
        "physics",
        "quantum",
        "thermodynamic",
        "mechanics",
        "relativity",
        # ENHANCED: Formal math domains
        "algebra",
        "calculus",
        "geometry",
        "topology",
    ...
    # ENHANCED: Expanded probability keywords
    prob_keywords = [
        "probability",
        "prior",
        "posterior",
        ...
        "frequentist",
        "distribution",
        # ENHANCED: Additional probability terms
        "expectation",
        "expected value",
        "variance",
        "stochastic",
    ...
    # ENHANCED: Expanded Bayesian keywords
    bayesian_keywords = [
        "bayes",
        "bayesian",
        "prior",
        ...
        "positive predictive",
        "negative predictive",
        # ENHANCED: Additional Bayesian/statistical terms
        "likelihood ratio",
        "odds ratio",
        "confidence",
        "credible interval",
    ...
    # ENHANCED: Expanded statistical keywords
    stat_keywords = [
        "mean",
        "variance",
        "standard deviation",
        ...
        "significance",
        "correlation",
        # ENHANCED: Additional statistics terms
        "regression",
        "anova",
        "chi-square",
        "t-test",
    ...
    # ENHANCED: Quantum physics and advanced physics keywords
    physics_keywords = [
        "quantum",
        "wave function",
        "hamiltonian",
    ...
    for kw in physics_keywords:
        if kw in description or kw in problem_type:
            context.has_probability = True  # Quantum often involves probability
            context.is_mathematical = True
            context.problem_type = "physics"
            break

    # ENHANCED: Mathematical proof and derivation keywords
    proof_keywords = [
        "prove",
        "proof",
        "theorem",
    ...
    for kw in proof_keywords:
        if kw in description or kw in problem_type:
            context.is_mathematical = True
            context.problem_type = "proof"
            break

    # ENHANCED: Calculus and advanced math keywords
    calculus_keywords = [
        "integral",
        "derivative",
        "differential",
    ...
    if hasattr(problem_graph, "nodes"):
        for node_id, node_data in problem_graph.nodes.items():
            if isinstance(node_data, dict):
                ...
                if any(
                    kw in node_type
                    for kw in ["compute", "calculate", "math", "solve", "derive"]
                ):
                    context.is_mathematical = True
                    context.has_arithmetic = True
...
class EnhancedMathematicalDecomposer:
    ...
    def __init__(
        ...
        if MATH_VERIFICATION_AVAILABLE:
            self.math_engine = MathematicalVerificationEngine(config=self.math_config)
    ...
    def _verify_mathematical_outcome(
        ...
        if verification_results:
            outcome = self._apply_verification_results(outcome, verification_results)
        ...
        for result in results:
            if result.status == MathVerificationStatus.ERROR_DETECTED:
                ...
                if result.corrections:
                    self._apply_corrections_to_solution(outcome, result.corrections)
    ...
    def get_math_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "engine_statistics": (
                self.math_engine.get_statistics() if self.math_engine else {}
            ),
        }

    def get_likely_errors(self, problem: "BayesianProblem") -> List[MathErrorType]:
        """
