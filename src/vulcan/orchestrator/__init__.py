...
def get_module_info() -> dict:
    ...
    return {
        ...
        'self_improvement': {
            ...
            'fully_available': EXPERIMENT_GENERATOR_AVAILABLE and PROBLEM_EXECUTOR_AVAILABLE
        }
    }
...
def print_module_info():
    ...
    si_status = 'Fully Available' if si['fully_available'] else 'Partially Available' if (si['experiment_generator'] or si['problem_executor']) else 'Not Available'
...
def validate_installation() -> bool:
    ...
    try:
        ...
        if not EXPERIMENT_GENERATOR_AVAILABLE:
            logger.warning("ExperimentGenerator not available - self-improvement experiments disabled")
        
        if not PROBLEM_EXECUTOR_AVAILABLE:
            logger.warning("ProblemExecutor not available - self-improvement execution disabled")
...
def create_production_deployment(config, checkpoint_path=None, orchestrator_type="parallel"):
    """
