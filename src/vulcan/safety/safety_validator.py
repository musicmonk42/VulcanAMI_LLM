            ...
            try:
                if not validator.check(query, context):
                    ...
                    if validator_name == "PromptInjectionValidator":
                        ...
                        reasons.append(
                            "Query contains potential prompt injection attempt"
                        )
                ...
                logger.error(
                    f"Query validator {validator.__class__.__name__} failed: {e}"
                )
    ...
    def validate_response(self, response: str, original_query: str) -> SafetyReport:
        ...
        for validator in self.llm_validators:
            try:
                ...
                logger.error(
                    f"Response validator {validator.__class__.__name__} failed: {e}"
                )
