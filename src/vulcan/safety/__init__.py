...
class SafetyUnavailable:
    ...
    def validate(self, *a, **k): return {"status": "unavailable", "safe": True}
    def clamp(self, *a, **k): return a[0] if a else None
    def get_status(self): return {"available": False, "reason": "lazy import not resolved"}
