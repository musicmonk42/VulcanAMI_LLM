...
class TestGracefulDegradation:
    ...
    def test_switch_to_local_mode(self):
        ...
        protocol.capabilities["test_local_cap"] = {"enabled": False}
    ...
    def test_disable_network_capabilities(self):
        ...
        protocol.capabilities["net_cap_1"] = {"enabled": True, "network_required": True}
        protocol.capabilities["net_cap_2"] = {"enabled": True, "network_required": True}
