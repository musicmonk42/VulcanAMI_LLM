...
class TestVulcanPackVerify:
    ...
    def test_verify_valid_pack(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            build_result = run_vulcan_pack(
                ["-i", input_file, "-o", pack_file, "--no-dqs"], timeout=30
            )
            assert build_result.returncode == 0

            # Verify pack
            verify_result = run_vulcan_pack_verify([pack_file], timeout=30)
    ...
    def test_verify_with_full_flag(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Build pack
            run_vulcan_pack(["-i", input_file, "-o", pack_file, "--no-dqs"], timeout=30)

            # Verify with --full
            result = run_vulcan_pack_verify([pack_file, "--full"], timeout=30)
    ...
    def test_verify_with_verbose_flag(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = run_vulcan_pack_verify([pack_file, "--verbose"], timeout=30)
    ...
    def test_verify_with_quiet_flag(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = run_vulcan_pack_verify([pack_file, "--quiet"], timeout=30)
    ...
    def test_verify_with_json_output(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = run_vulcan_pack_verify(
                [pack_file, "--json", json_output], timeout=30
            )
    ...
    def test_verify_invalid_magic_number(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert (
                "FAILED" in output or "Invalid" in output or "magic" in output.lower()
            )

    def test_verify_nonexistent_file(self):
        """Test verification of non-existent file"""
        result = run_vulcan_pack_verify(["/nonexistent/file.pack"], timeout=30)
    ...
    def test_verify_merkle_flag(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = run_vulcan_pack_verify([pack_file, "--merkle"], timeout=30)
    ...
    def test_verify_bloom_flag(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = run_vulcan_pack_verify([pack_file, "--bloom"], timeout=30)
    ...
    def test_verify_checksums_flag(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            result = run_vulcan_pack_verify([pack_file, "--checksums"], timeout=30)
    ...
    def test_no_arguments_shows_help(self):
        ...
        result = run_vulcan_pack_verify([], timeout=30)
