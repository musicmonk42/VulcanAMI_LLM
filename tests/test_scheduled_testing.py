...
class TestAttackExecution:
    ...
    def test_run_attack_success(self):
        ...
        mock_validator = Mock()
        mock_validator.validate_robustness = Mock(
            return_value={"robustness_score": 0.85, "attack_success": False}
        )
...
class TestScheduledTestExecution:
    ...
    def test_run_scheduled_tests_custom_attacks(self):
        ...
        mock_validator = Mock()
        mock_validator.validate_robustness = Mock(
            return_value={"robustness_score": 0.85}
        )
    ...
    def test_save_results(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                results_files = list(
                    Path(tmpdir).glob("adversarial_test_results_*.json")
                )
...
class TestAlertGeneration:
    ...
    def test_alert_on_low_robustness(self):
        ...
        mock_validator = Mock()
        mock_validator.validate_robustness = Mock(
            return_value={"robustness_score": 0.5}  # Below default threshold of 0.8
        )
    ...
    def test_no_alert_on_high_robustness(self):
        ...
        mock_validator = Mock()
        mock_validator.validate_robustness = Mock(
            return_value={"robustness_score": 0.95}  # Above threshold
        )
...
class TestEdgeCases:
    ...
    def test_empty_attack_types(self):
        ...
        config = {"attack_types": [], "epsilon_values": [0.1], "save_results": False}
    ...
    def test_empty_epsilon_values(self):
        ...
        config = {"attack_types": ["fgsm"], "epsilon_values": [], "save_results": False}
