...
output "cloudfront_etag" {
  ...
  value       = var.enable_cloudfront ? aws_cloudfront_distribution.cdn[0].etag : null
}
...
output "rds_connection_string" {
  ...
  value       = var.enable_rds ? "postgresql://${aws_db_instance.main[0].username}@${aws_db_instance.main[0].address}:${aws_db_instance.main[0].port}/${aws_db_instance.main[0].db_name}" : null
  sensitive   = true
}

output "rds_availability_zone" {
  description = "RDS instance availability zone"
  value       = var.enable_rds ? aws_db_instance.main[0].availability_zone : null
}

output "rds_multi_az" {
  description = "Whether RDS instance is multi-AZ"
  value       = var.enable_rds ? aws_db_instance.main[0].multi_az : null
}

output "rds_backup_window" {
  description = "RDS backup window"
  value       = var.enable_rds ? aws_db_instance.main[0].backup_window : null
}

output "rds_maintenance_window" {
  description = "RDS maintenance window"
  value       = var.enable_rds ? aws_db_instance.main[0].maintenance_window : null
}
...
output "redis_member_clusters" {
  description = "Redis member cluster IDs"
  value       = var.enable_redis ? aws_elasticache_replication_group.main[0].member_clusters : null
}
...
output "ecs_dqs_task_definition_arn" {
  description = "ECS DQS task definition ARN"
  value       = var.enable_ecs ? aws_ecs_task_definition.dqs[0].arn : null
}
...
output "ecs_opa_task_definition_arn" {
  description = "ECS OPA task definition ARN"
  value       = var.enable_ecs ? aws_ecs_task_definition.opa[0].arn : null
}
...
output "ecs_task_role_arn" {
  ...
  value       = var.enable_ecs ? aws_iam_role.ecs_task[0].arn : null
}

output "replication_role_arn" {
  description = "S3 replication role ARN"
  value       = var.enable_bucket_replication ? aws_iam_role.replication[0].arn : null
}
...
output "backup_role_arn" {
  description = "AWS Backup role ARN"
  value       = var.enable_aws_backup ? aws_iam_role.backup[0].arn : null
}
